...
extern mavlink_mission_request_list_t mavlink_in_mission_request_list_struct;
extern mavlink_mission_clear_all_t mavlink_in_mission_clear_all_struct;
    ...
    if (c != Q_TIMEOUT){
      if (mavlink_parse_char(MAVLINK_COMM_0, (uint8_t)c, &msg, &status)) {
        ...
        case MAVLINK_MSG_ID_COMMAND_LONG:
          ...
          if (mavlink_in_command_long_struct.target_system == mavlink_system_struct.sysid)
        ...
        case MAVLINK_MSG_ID_PARAM_SET:
          ...
          if (mavlink_in_param_set_struct.target_system == mavlink_system_struct.sysid)
        ...
        case MAVLINK_MSG_ID_PARAM_REQUEST_LIST:
          ...
          if (mavlink_in_param_request_list_struct.target_system == mavlink_system_struct.sysid)
        ...
        case MAVLINK_MSG_ID_PARAM_REQUEST_READ:
          ...
          if (mavlink_in_param_request_read_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_param_request_read, EVMSK_MAVLINK_IN_PARAM_REQUEST_READ);
          break;

        case MAVLINK_MSG_ID_SET_MODE:
          mavlink_msg_set_mode_decode(&msg, &mavlink_in_set_mode_struct);
          if (mavlink_in_set_mode_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_set_mode, EVMSK_MAVLINK_IN_SET_MODE);
          break;

        case MAVLINK_MSG_ID_MISSION_SET_CURRENT:
          mavlink_msg_mission_set_current_decode(&msg, &mavlink_in_mission_set_current_struct);
          if (mavlink_in_mission_set_current_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_mission_set_current, EVMSK_MAVLINK_IN_MISSION_SET_CURRENT);
          break;

        case MAVLINK_MSG_ID_MISSION_REQUEST_LIST:
          mavlink_msg_mission_request_list_decode(&msg, &mavlink_in_mission_request_list_struct);
          if (mavlink_in_mission_request_list_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_mission_request_list, EVMSK_MAVLINK_IN_MISSION_REQUEST_LIST);
          break;

        case MAVLINK_MSG_ID_MISSION_CLEAR_ALL:
          mavlink_msg_mission_clear_all_decode(&msg, &mavlink_in_mission_clear_all_struct);
          if (mavlink_in_mission_clear_all_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_mission_clear_all, EVMSK_MAVLINK_IN_MISSION_CLEAR_ALL);
          break;

        case MAVLINK_MSG_ID_MISSION_COUNT:
          mavlink_msg_mission_count_decode(&msg, &mavlink_in_mission_count_struct);
          if (mavlink_in_mission_count_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_mission_count, EVMSK_MAVLINK_IN_MISSION_COUNT);
          break;

        case MAVLINK_MSG_ID_MISSION_ITEM:
          mavlink_msg_mission_item_decode(&msg, &mavlink_in_mission_item_struct);
          if (mavlink_in_mission_item_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_mission_item, EVMSK_MAVLINK_IN_MISSION_ITEM);
          break;

        case MAVLINK_MSG_ID_MISSION_REQUEST:
          mavlink_msg_mission_request_decode(&msg, &mavlink_in_mission_request_struct);
          if (mavlink_in_mission_request_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_in_mission_request, EVMSK_MAVLINK_IN_MISSION_REQUEST);
          break;

        case MAVLINK_MSG_ID_MISSION_ACK:
          mavlink_msg_mission_ack_decode(&msg, &mavlink_in_mission_ack_struct);
          if (mavlink_in_mission_ack_struct.target_system == mavlink_system_struct.sysid)
