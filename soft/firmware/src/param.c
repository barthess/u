...
GlobalParam_t global_data[] = {
    ...
    /* смещения осей гироскопа */
    {"GYRO_xoffset",    110,   -5000,     5000,       MAVLINK_TYPE_INT32_T},
    {"GYRO_yoffset",    -90,   -5000,     5000,       MAVLINK_TYPE_INT32_T},
    {"GYRO_zoffset",    351,   -5000,     5000,       MAVLINK_TYPE_INT32_T},
