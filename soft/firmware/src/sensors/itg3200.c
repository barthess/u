...
/**
 * ѕолучение приращени€ угла исход€ из угловой скорости и временем между выборками
 */
...
//        mavlink_scaled_imu_struct.zgyro = (int16_t)(1000 * comp_data.zgyro);
      ...
      //TODO: event GyroFail
      /* значени€, сигнализирующие о сбое */
